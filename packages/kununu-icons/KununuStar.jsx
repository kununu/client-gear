...
const Icon = ({className, ariaHidden}) => (
  ...
  >
    <path
      d="M-98.1,247.5c3.9,3.9,10.2,3.7,14.1-0.1l3.7-3.6c4-3.8,4.1-10.1,0.2-14l-29.2-28.6c-4.9-4.8-4.8-12.8,0.1-17.6 l4.8-4.7c4.9-4.8,13-4.8,17.9,0l29.1,28.6c3.9,3.8,10.5,3.5,14.4-0.3l3.7-3.6c3.9-3.9,3.9-10.2,0-14l-1.8-1.8l-27.3-26.6
    ...
    <path
      ...
      c-3.9-3.8-10.4-4-14.4-0.2l-29.2,28.5c-4.9,4.8-13,4.7-17.9-0.1l-4.8-4.7c-5-4.8-5-12.6,0-17.5l29.2-28.5c3.9-3.9,3.6-10.3-0.3-14.1 l-3.7-3.6c-3.9-3.9-10.4-3.9-14.3,0l-1.8,1.7l-27.3,26.7c-15.1,14.9-15.2,38.7-0.2,53.4L-123,349.3z"
    />
  </svg>
);
