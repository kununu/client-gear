...
const Icon = ({className}) => (
  ...
  >
    ...
    <path d="M-19.8,207.5c3.9,3.8,10.4,4,14.3,0.2l29.2-28.6c4.9-4.8,13.1-4.7,18,0.1l4.8,4.7c4.9,4.8,4.9,12.6,0,17.4
    ...
    <path d="M-22,322.3L5.4,349c15,14.8,39.4,14.9,54.5,0.2l4.7-4.6c15.1-14.7,14.9-38.5-0.2-53.2l-29.3-28.6
    ...
    <path d="M-123,349.3c15.1,14.7,39.4,14.6,54.5-0.2l29.3-28.6c3.9-3.8,3.8-10-0.2-13.8l-3.7-3.7
